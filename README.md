...
cd existing_repo
<<<<<<< HEAD
git remote add origin https://gitlab.com/mmorg/bupm/ariane-dataspace-connector.git
=======
git remote add origin https://gitlab.com/mmorg/bupm/ariane.git
>>>>>>> eeafae1 (Ariane DSC)
git branch -M main
...
<<<<<<< HEAD
- [ ] [Set up project integrations](https://gitlab.com/mmorg/bupm/ariane-dataspace-connector/-/settings/integrations)
=======
- [ ] [Set up project integrations](https://gitlab.com/mmorg/bupm/ariane/-/settings/integrations)
>>>>>>> eeafae1 (Ariane DSC)
