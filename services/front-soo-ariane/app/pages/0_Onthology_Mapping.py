...
def create_rule(field):
    ...
    if st.session_state[f"generateID_{field}"] and st.session_state[f'object_{field}']['class'] == 'Profile':
        ...
        rule["relationName"] = "soo:experience"
        rule["relationNameInverse"] =  "soo:profile"
    ...
    if st.session_state[f'property4{field}'] == "soo:skillLevelValue":
        rule['targetFunction'] = "fno:as-is"
        
    if st.session_state[f'property4{field}'] == "skos:prefLabel" and st.session_state[f'object_{field}']['class'] == 'Experience':
