...
def main():
    ...
    with cols[0],st.container(border=True):
        ...
        st.divider()
        if st.button("Let's map my data !",use_container_width=True): st.switch_page("pages/1_🧩_Onthology_Mapping.py")
    with cols[1],st.container(border=True):
        ...
        st.divider()
        if st.button("Let's map my framework !",use_container_width=True): st.switch_page("pages/2_🔀_Framework_Mapping.py")
    with cols[2],st.container(border=True):
        ...
        st.divider()
        if st.button("Let's enhance my trainings !",use_container_width=True): st.switch_page("pages/3_🪧_Traning_Enhancement.py")
