...
class OntologyService:
    ...
    def generate_mapping_from_provider_rules(
        self, name: str, document: list[dict]
    ) -> dict:
        rules = get_rules(name)
    ...
    def generate_mapping_from_rules_provided(
        self, mapping_rules: List[Rule], document: list[dict]
    ) -> dict:
