...
class SourceMappingEngine:
    ...
    def get_gql_create_or_find_mapping(
        self, provider_name: str, source_value: str, source_type: str, source_language: str, target_framework: str
    ) -> dict:
        ...
        term_matching_responses = self.term_matching_engine.get_gql_term_matching(
        ...
        for instance in documents["graph"]:
            if "__matching__" in instance:
                ...
                if not concept_id in instances:
                    mappings_list = self.get_gql_create_or_find_mapping(
