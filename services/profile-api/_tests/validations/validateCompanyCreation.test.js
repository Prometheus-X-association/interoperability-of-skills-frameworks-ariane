...
const validateCompanyCreation = (
  await import("../../src/validations/validateCompanyCreation.js")
).default;

describe("test validateCompanyCreation", () => {
  beforeEach(() => {
    jest.clearAllMocks();
    mockCheckUniqueValidity.mockImplementation(() => Promise.resolve());
  });

  it("should validate attributes correctly when creating a single company", async () => {
    const mockDetail = {
    ...
    await validateCompanyCreation(null, mockArgs, { dataLoader: {} }, {});
